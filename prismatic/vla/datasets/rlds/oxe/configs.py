...
OXE_DATASET_CONFIGS = {
    ...
    "rl_hexagon_place_dataset:1.0.0": {
        "image_obs_keys": {
            "primary": "image_side",
            "secondary": "image_side_2",
            "wrist": "image_wrist_1",
    ...
    "fmb_single_object_insert_dataset": {
        "image_obs_keys": {
            "primary": "image_side_1",
            "secondary": "image_side_2",
            "wrist": "image_wrist_1",
    ...
    "fmb_grasp_dataset:1.0.0": {
        "image_obs_keys": {
            "primary": "image_side_2",
            "secondary": "image_side_2",
            "wrist": "image_wrist_1",
        },
        "depth_obs_keys": {
